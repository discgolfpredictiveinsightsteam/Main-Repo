...
// function players1() {
  ...
  //   const players = allMovies;
  //   // Need to figure out how to get the array of all players to fit in where "allMovies" is.
  ...
  //   // Gonna have to make change to .flexselect in css to include flexselect1,2, and 3.
  //   const players = allMovies;
  //   // Need to figure out how to get the array of all datetimes to fit in where "allMovies" is.
  //   players.forEach(element => {
  //     const row = selector.append("option").attr("value", element);
  //     row.text(element);
  //   });
  ...
  // ​
  // jQuery(document).ready(function() {
  //   $("select.flexselect3").flexselect();
  // });

  // Do I need to create a new function for each player? Yes.